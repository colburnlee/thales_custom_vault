...
const marketschecker = require("./arbitrumMarketschecker.js");

const data = require("../arbitrumData.json");
const fs = require("fs");
...
async function processVault(auth) {
  ...
  let gasp = await constants.arbitrumProvider.getGasPrice();
  ...
  console.log(
    `ARBITRUM Vault - Round: ${round}, Price Upper Limit: ${priceUpperLimit}, Price Lower Limit: ${priceLowerLimit}, Skew Impact Limit: ${skewImpactLimit}  `
  );
